                ...
                <Container fluid className='card-outline bodyColor'>
                    {this.state.bookingInfo.length === 0 ? (
                        <div className="empty-bookings">
                            <img 
                                src="https://media.giphy.com/media/3o7TKnxnXxzPKpKYYE/giphy.gif" 
                                alt="Empty bookings" 
                                className="empty-gif"
                            />
                            <h2>Oops! Your Booking List is as Empty as a Theater on Oscar Night!</h2>
                            <p>Time to grab some popcorn and book your first movie adventure!</p>
                            <Button className="see-movie-btn" href="/">
                                <span className="btn-link">Explore Movies</span>
                            </Button>
                        </div>
                    ) : (
                        <Row xs={1} md={1} lg={2}>
